...
function _connect() {
  _connect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var ConnectUserWallet, UserAddress, cypxAmount, mintbtn, UserBalance, UserBalanceErg, assets, dashboard, assetsHTML;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
        ...
        case 23:
          ...
          assets.forEach(function (asset) {
            assetsHTML += "\n      <div>\n        <p>Asset name: ".concat(asset.name, "</p>\n        <p>Token ID: ").concat(asset.tokenId, "</p>\n        <p>Amount: ").concat(asset.amount, "</p>\n      </div>\n    ");
          });
        case 27:
        case "end":
          return _context.stop();
...
function _displayCybercitizenAssets() {
  _displayCybercitizenAssets = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(userAddress) {
