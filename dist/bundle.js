...
function _connect() {
  _connect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var ConnectUserWallet, UserAddress, cypxAmount, mintbtn, UserBalance, UserBalanceErg, assets, assetsHTML, audioNFTs, audioNFTsContainer, audioNFTsHTML;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
